...
cp_path = '../data/modelcheckpoint/Motion_KeyPoint/model/Dacon_Motion_KeyPoint01.hdf5'
...
submission.to_csv('../data/modelcheckpoint/Motion_KeyPoint/submission/Dacon_Motion_KeyPoint.csv', index = False)