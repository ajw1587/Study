...
np.save('../data/lotte/lotte_data/train_x(224,224)_02.npy', arr=X)
np.save('../data/lotte/lotte_data/train_y(224,224)_02.npy', arr=y)
x = np.load('../data/lotte/lotte_data/train_x(224,224)_02.npy' ,allow_pickle=True)
y = np.load('../data/lotte/lotte_data/train_y(224,224)_02.npy' ,allow_pickle=True)
