...
def parse_arguments():
    ...
    parser.add_argument(
        ...
        default = 'F:/Team_Project/OCR/01_Text_detection/data2_parksunwoo/'
        # default="out/"
    )
    parser.add_argument(
        "-i",
...
def main():
    ...
    if args.name_format == 2:
        ...
        with open("F:/Team Project/OCR/01_Text_detection/data2_parksunwoo/labels.txt", 'w', encoding="utf8") as f:
