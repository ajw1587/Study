...
np.save('../data/npy/mnist_m_x_train.npy', arr = m_x_train)
np.save('../data/npy/mnist_m_x_test.npy', arr = m_x_test)
np.save('../data/npy/mnist_m_y_train.npy', arr = m_y_train)
np.save('../data/npy/mnist_m_y_test.npy', arr = m_y_test)

# 7. fashion
(m_x_train, m_y_train),(m_x_test, m_y_test) = fashion_mnist.load_data()
np.save('../data/npy/fashion_mnist_m_x_train.npy', arr = m_x_train)
np.save('../data/npy/fashion_mnist_m_x_test.npy', arr = m_x_test)
np.save('../data/npy/fashion_mnist_m_y_train.npy', arr = m_y_train)
np.save('../data/npy/fashion_mnist_m_y_test.npy', arr = m_y_test)

# 8. cifar10
(c10_x_train, c10_y_train),(c10_x_test, c10_y_test) = cifar10.load_data()
np.save('../data/npy/cifar10_c10_x_train.npy', arr = c10_x_train)
np.save('../data/npy/cifar10_c10_x_test.npy', arr = c10_x_test)
np.save('../data/npy/cifar10_c10_y_train.npy', arr = c10_y_train)
np.save('../data/npy/cifar10_c10_y_test.npy', arr = c10_y_test)

# 9. cifar100
(c100_x_train, c100_y_train),(c100_x_test, c100_y_test) = cifar100.load_data()
np.save('../data/npy/cifar100_c100_x_train.npy', arr = c100_x_train)
np.save('../data/npy/cifar100_c100_x_test.npy', arr = c100_x_test)
np.save('../data/npy/cifar100_c100_y_train.npy', arr = c100_y_train)
np.save('../data/npy/cifar100_c100_y_test.npy', arr = c100_y_test)
