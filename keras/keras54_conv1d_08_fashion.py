...
model.add(Conv1D(100, 2, padding = 'same'))         # padding = valid: 패딩 사용 안함
model.add(Dense(100))
...
model.fit(x_train, y_train, batch_size = 20, epochs = 100, validation_split = 0.2,
          callbacks = [es])
