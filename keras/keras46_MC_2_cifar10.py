...
file_path = './modelCheckpoint/k46_2_cifar10_{epoch:02d}_{val_loss:.4f}.hdf5'
...
model.fit(x_train, y_train, epochs = 50, batch_size = 32, validation_split = 0.2, callbacks = [es, cp])
