...
dense2 = Dense(5, activation = "relu", name = "model2-4")(dense2)
...
middle1 = Dense(30, name = "merge-1")(merge1)
middle1 = Dense(10, name = "merge-2")(middle1)
middle1 = Dense(10, name = "merge-3")(middle1)
...
output2 = Dense(7, name = "output2-2")(output2)
