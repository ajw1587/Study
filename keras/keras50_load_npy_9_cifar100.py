...
x_train = np.load('../data/npy/cifar100_c100_x_train.npy')
x_test = np.load('../data/npy/cifar100_c100_x_test.npy')
y_train = np.load('../data/npy/cifar100_c100_y_train.npy')
y_test = np.load('../data/npy/cifar100_c100_y_test.npy')
...
model.fit(x_train, y_train, epochs = 100, batch_size = 100, validation_split = 0.2, callbacks = [es, cp, tb])
