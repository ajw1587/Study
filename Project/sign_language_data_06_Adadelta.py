...
# Model
opti = Adadelta(learning_rate = 0.001)
es = EarlyStopping(monitor = 'val_loss', patience = 100, mode = 'auto')
cp = ModelCheckpoint('../data/modelcheckpoint/sign_language/sign_language_model_Adadelta.hdf5')
...
model2 = load_model('../data/modelcheckpoint/sign_language/sign_language_model_Adadelta.hdf5')
...
# 3가지 모델 중 가장 느림! 성능도 그닥...
# acc:  0.7337740659713745
# loss:  0.9591978192329407
# val_acc:  0.6746794581413269
# val_loss:  1.2265244722366333
# RMSE:  0.12478891