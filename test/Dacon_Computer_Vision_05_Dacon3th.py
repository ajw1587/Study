...
train_aug = ImageDataGenerator(rescale = 1./255., height_shift_range=(-1,1), 
...
opti = Adam(learning_rate = 0.002, epsilon = None)
skf = StratifiedKFold(n_splits = 20) # 40
result = 0
Acc = []
i = 1
...
for train_index, valid_index in skf.split(train_x, train_y):
    ...
    train_generator = train_aug.flow(x_train, y_train, batch_size = 8)
