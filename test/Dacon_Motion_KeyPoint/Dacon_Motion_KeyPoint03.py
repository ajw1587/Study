...
# Model
efficient = EfficientNetB7(include_top = False, weights = 'imagenet', input_shape = (180, 320, 3))
...
cp_path = '../data/modelcheckpoint/Motion_KeyPoint/model/Dacon_Motion_KeyPoint03.hdf5'
...
submission.to_csv('../data/modelcheckpoint/Motion_KeyPoint/submission/Dacon_Motion_KeyPoint3.csv')