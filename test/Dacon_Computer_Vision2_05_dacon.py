...
# Dacon Dataset Load
labels_df = pd.read_csv('../data/csv/Computer_Vision2/dirty_mnist_2nd_answer.csv')[:]
imgs_dir = np.array(sorted(glob.glob('../data/csv/Computer_Vision2/dirty_mnist_2nd/*')))[:]
labels = np.array(labels_df.values[:,1:])

test_imgs_dir = np.array(sorted(glob.glob('../data/csv/Computer_Vision2/test_dirty_mnist_2nd/*')))
...
# Test 추론
submission = pd.read_csv('../data/csv/Computer_Vision2/sample_submission.csv')
