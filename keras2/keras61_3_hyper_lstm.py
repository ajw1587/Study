...
def build_model(drop = 0.5, lr = 0.01, outputlayer = 10,
    ...
    x = LSTM(512, activation = act_func, name = 'hidden1')(inputs)
    x = Dropout(drop)(x)
...
print('(1): ', search.best_params_)         #  {'lr': 0.001, 'hiddenlayer': 32, 'epochs': 20, 'drop': 0.2, 'batch_size': 50, 'act_func': 'tanh'}
print('(2): ', search.best_estimator_)      # <tensorflow.python.keras.wrappers.scikit_learn.KerasClassifier object at 0x000002C30B704C10>
print('(3): ', search.best_score_)          # 0.953849991162618

acc = search.score(x_test, y_test)
print('최종 스코어: ', acc)                  # 0.9555000066757202