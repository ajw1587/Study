...
# 3. 훈련
model.fit(x_train, y_train, use_label_encoder = False)

# 4. 평가, 예측
acc = model.score(x_test, y_test, eval_metrics = 'mlogloss')
...
print(time_delta1)
##################################
# 1. n_jobs = -1 -> 0:00:00.079432
# 2. n_jobs =  8 -> 0:00:00.077792
# 3. n_jobs =  4 -> 0:00:00.078790
# 4. n_jobs =  1 -> 0:00:00.079866
