...
for i in range(6):
    scores = cross_val_score(model[i], x_train, y_train, cv=kfold)      # model과 Data를 엮어주는 역할, evaluate
...
print(result2)
'''
# LinearSVC() scores:  [0.95833333 1.         1.         1.         0.95833333]
# SVC() scores:  [0.95833333 0.95833333 0.95833333 0.95833333 0.95833333]
# KNeighborsClassifier() scores:  [1.         1.         1.         0.95833333 0.95833333]
# LogisticRegression() scores:  [0.95833333 0.95833333 1.         0.95833333 1.        ]
# DecisionTreeClassifier() scores:  [0.95833333 1.         0.91666667 0.91666667 0.91666667]
# RandomForestClassifier() scores:  [0.95833333 0.95833333 1.         0.95833333 1.        ]